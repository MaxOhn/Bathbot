...
use crate::{commands::osu::CompareResult, embeds::attachment, manager::redis::osu::CachedOsuUser};
...
impl<'u> UserData<'u> {
    fn new(user: &'u CachedOsuUser, osutrack_peaks: Option<&RankAccPeaks>) -> Self {
