...
use crate::{embeds::attachment, manager::redis::osu::CachedOsuUser, util::CachedUserExt};
...
impl SnipedEmbed {
    pub fn new(user: &CachedOsuUser, sniper: Vec<SnipedWeek>, snipee: Vec<SnipedWeek>) -> Self {
